...
# LtC
optim_group.add_argument('--ltc', action='store_true', default=False)
optim_group.add_argument('--w', default=1.5, type=float)
optim_group.add_argument('--C', default=0.5, type=float)